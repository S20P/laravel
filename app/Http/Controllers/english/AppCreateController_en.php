...
//----How Would Your Future House, Car and Love Look Like?---------------------------------------------------app46--
          ...
          public function en_app46_createimg(){
            ...
            $dir = "images/english/app46/bg-sample/";
            $pictures = glob("$dir/{*.jpg,*.jpeg,*.gif,*.png}",GLOB_BRACE);
            $img_path = $pictures[mt_rand(0,count($pictures)-1)];
...
//app61-------What was your profession in the wild west?----------------------------------------------------
          ...
          public function en_app61_createimg(){
            ...
            // paste another image
              ...
              $dir = "images/english/app61/bg-sample/";
              $pictures = glob("$dir/{*.jpg,*.jpeg,*.gif,*.png}",GLOB_BRACE);
              $img_path = $pictures[mt_rand(0,count($pictures)-1)];
...
//app71----Who is your famous celebrity lookalike?-------------------------------------------
          ...
          public function en_app71_createimg(){
            ...
            // paste another image
              ...
              $dir = "images/english/app71/bg-sample/";
              $pictures = glob("$dir/{*.jpg,*.jpeg,*.gif,*.png}",GLOB_BRACE);
              $img_path = $pictures[mt_rand(0,count($pictures)-1)];
...
//app80----What will your daughter look like?---------------------------------------------
          ...
          public function en_app80_createimg(){
            ...
            $html = view('english.Result_Share_fb_page',array('app_no'=>"80",'img_url'=>$fullimage_path,'app_title'=>$this->app_store_info[79]['app_title'],"app_description"=>$app_description,"app_sub_description"=>$app_sub_description), compact('view'))->render();
            return response()->json(compact('html'));
            }
            else{
                 return Redirect::route('redirect');
...
//app81----What does your face say about your body and soul?-------------------------------------------
...
//app82----Which mixed-race are you based on your photo?------------------------------------------
          ...
          public function en_app82(){
                          ...
                          return  view('english.app_view_home',array('app_no'=>"82",'app_title'=>$this->app_store_info[81]['app_title'],'app_img_orignal_url'=>$this->app_store_info[81]['app_img_orignal_url']));
          }
...
//app83----What does 2018 have in store for you?--------------------------------------------
          ...
          public function en_app83(){
                          ...
                          return  view('english.app_view_home',array('app_no'=>"83",'app_title'=>$this->app_store_info[82]['app_title'],'app_img_orignal_url'=>$this->app_store_info[82]['app_img_orignal_url']));
          }
...
//app84----What is your best asset?-------------------------------------------
          ...
          public function en_app84(){
                          ...
                          return  view('english.app_view_home',array('app_no'=>"85",'app_title'=>$this->app_store_info[83]['app_title'],'app_img_orignal_url'=>$this->app_store_info[83]['app_img_orignal_url']));
          }
...
//app85----What describes you best?--------------------------------------------
          ...
          public function en_app85(){
                          ...
                          return  view('english.app_view_home',array('app_title'=>$this->app_store_info[84]['app_title'],'app_img_orignal_url'=>$this->app_store_info[84]['app_img_orignal_url']));
          }
...
//app111----What are 5 reasons people are jealous of You?---------------------------------------------

          public function en_app111(){

                          MetaTag::set('title', 'wittyfunyfeeds | '.$this->app_store_info[110]['app_title']);
...
//app112----What are 5 reasons people are jealous of You?---------------------------------------------
...
//app113----What are 5 reasons people are jealous of You?---------------------------------------------
...
//app114----What are 5 reasons people are jealous of You?---------------------------------------------
...
//app115----What are 5 reasons people are jealous of You?---------------------------------------------
