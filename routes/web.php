...
Route::group(['prefix'=>'en','namespace'=>'english'], function(){
        ...
        //  Route::get('/defult_app_en','HomeController_englishApp@defult_app_en');
          ...
          //app7
          Route::get('/What-Awaits-You-From-2018-to-2020','AppCreateController_en@en_app7');
         ...
         //app53
          ...
          //app81
          Route::get('/What-does-your-face-say-about-your-body-and-soul','AppCreateController_en@en_app81');
          Route::get('/en_app81_createimg','AppCreateController_en@en_app81_createimg');

          //app82
          Route::get('/Which-mixed-race-are-you-based-on-your-photo','AppCreateController_en@en_app82');
          Route::get('/en_app82_createimg','AppCreateController_en@en_app82_createimg');

          //app83
          Route::get('/What-does-2018-have-in-store-for-you','AppCreateController_en@en_app83');
          Route::get('/en_app83_createimg','AppCreateController_en@en_app83_createimg');

          //app84
          Route::get('/What-is-your-best-asset','AppCreateController_en@en_app84');
          Route::get('/en_app84_createimg','AppCreateController_en@en_app84_createimg');

          //app85
          Route::get('/What-describes-you-best','AppCreateController_en@en_app85');
          ...
          //app111
          Route::get('/What-are-5-reasons-people-are-jealous-of-You','AppCreateController_en@en_app111');
          Route::get('/en_app111_createimg','AppCreateController_en@en_app111_createimg');

          //app112
          Route::get('/What-are-5-reasons-people-are-jealous-of-You','AppCreateController_en@en_app112');
          Route::get('/en_app112_createimg','AppCreateController_en@en_app112_createimg');

          //app113
          Route::get('/What-are-5-reasons-people-are-jealous-of-You','AppCreateController_en@en_app113');
          Route::get('/en_app113_createimg','AppCreateController_en@en_app113_createimg');

          //app114
          Route::get('/What-are-5-reasons-people-are-jealous-of-You','AppCreateController_en@en_app114');
          Route::get('/en_app114_createimg','AppCreateController_en@en_app114_createimg');

          //app115
          Route::get('/What-are-5-reasons-people-are-jealous-of-You','AppCreateController_en@en_app115');
